      ...
      <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white font-poppins rounded-lg shadow-lg">
        ...
        <div className="flex items-center mt-6 -mx-2">
          <button
            ...
            type="submit"
            className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-pink-700 rounded-lg hover:bg-purple-700 focus:bg-purple-700 focus:outline-none"
          >
